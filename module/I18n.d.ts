import { DateTime, Dict, MissingPlaceholderHandler, NullPlaceholderHandler, PartialI18nOptions, Scope, TimeAgoInWordsOptions, ToNumberOptions, ToSentenceOptions, TranslateOptions } from "../index.d";
...
export declare class I18n {
    ...
    toCurrency(amount: number, options?: Dict<ToNumberOptions>): string;
    ...
    withLocale(locale: string, callback: () => void): void;
